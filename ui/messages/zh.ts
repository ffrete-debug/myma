export default {
  ...
  servers: {
    ...
    backupDownload: '下载备份',
    backupDelete: '删除备份',
    backupDeleteConfirm: '确定要删除此备份吗？',
    backupList: '备份列表',
    backupNoBackups: '暂无备份',
    backupFileSize: '文件大小',
    backupStatus: '状态',
    backupInProgress: '进行中',
    backupCompleted: '已完成',
    backupFailedStatus: '失败',
    backupRestore: '从备份恢复',
    backupRestoreConfirm: '确定要从此备份恢复吗？服务器将使用备份数据重新创建。',
    // 服务器卡片相关
    card: {
      startServer: '启动服务器',
      stopServer: '停止服务器',
    ...
    edit: {
      ...
      mapId: '地图ID',
      serverCreateError: '创建服务器失败，请检查填写内容后重试。',
      exportAll: '导出全部配置',
      importAll: '导入全部配置',
      exportFile: '下载',
      importFile: '导入'
    ...
    editor: {
      ...
      placeholder: '输入配置内容...',
      placeholders: {
        gameIni: '输入 Game.ini 配置内容...',
        gameUserSettings: '输入 GameUserSettings.ini 配置内容...',
      },
...
BabyImprintAmountMultiplier=1.0`
  ...
  mods: {
    ...
    server: '服务器',
    installed: '已安装模组（{count}）',
    loadOrderHint: '加载顺序很重要 \u2014 后面的模组会覆盖前面的。',
    restartHint: '重启服务器后模组更改才会生效。',
    noMods: '该服务器尚未添加模组。',
    browse: '创意工坊',
    searchPlaceholder: '搜索创意工坊\u2026',
    workshopIdPlaceholder: '按创意工坊 ID 添加',
    addByIdHint: '你仍可通过创意工坊 ID 添加模组。',
    add: '添加',
    added: '已添加',
    remove: '移除',
    enable: '启用',
    ...
    loadFailed: '无法加载模组',
    searchFailed: '创意工坊搜索失败',
    addFailed: '无法添加模组',
    removeFailed: '无法移除模组',
    updateFailed: '无法更新模组',
    reorderFailed: '无法保存加载顺序',
  },
  metrics: {
    title: '服务器指标',
    subtitle: '实时查看服务器的 CPU、内存与在线人数。',
    refresh: '立即刷新',
    updatedAt: '更新于 {time}',
    loadFailed: '无法加载指标',
    playersOnline: '在线玩家',
    serversRunning: '运行中的服务器',
    averageCpu: '平均 CPU',
    totalMemory: '内存总用量',
    noServers: '暂无服务器。',
    partialPlayerCount: '部分服务器未返回在线人数。',
    cpu: 'CPU',
    memory: '内存',
    players: '玩家',
    unknown: '未知',
    notRunning: '未运行',
    acrossCores: '共 {count} 个核心',
    severity: { good: '正常', warning: '偏高', critical: '严重' },
    status: { running: '运行中', stopped: '已停止' },
    errors: {
      'docker unavailable': 'Docker 不可用。',
      'container not found': '未找到容器。',
      'stats unavailable': '无法获取资源统计。',
    },
  },
  auditLogs: {
    title: '审计日志',
