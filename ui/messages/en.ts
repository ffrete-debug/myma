export default {
  ...
  servers: {
    ...
    backupDeleteConfirm: 'Are you sure you want to delete this backup?',
    backupList: 'Backups',
    ...
    backupRestoreConfirm: 'Are you sure you want to restore from this backup? The server will be recreated with the backup data.',
    // Server card related
    card: {
      startServer: 'Start Server',
      stopServer: 'Stop Server',
...
BabyImprintAmountMultiplier=1.0`
  ...
  backups: {
    ...
    cloudTarget: 'Uploading to {destination} via {provider}',
  ...
  mods: {
    ...
    server: 'Server',
    installed: 'Installed mods ({count})',
    loadOrderHint: 'Load order matters \u2014 later mods override earlier ones.',
    restartHint: 'Restart the server to apply mod changes.',
    noMods: 'No mods attached to this server.',
    browse: 'Steam Workshop',
    searchPlaceholder: 'Search the Workshop\u2026',
    workshopIdPlaceholder: 'Add by Workshop ID',
    addByIdHint: 'You can still add mods by their Workshop ID.',
    add: 'Add',
    added: 'Added',
    remove: 'Remove',
    enable: 'Enable',
    ...
    loadFailed: 'Could not load mods',
    searchFailed: 'Workshop search failed',
    addFailed: 'Could not add mod',
    removeFailed: 'Could not remove mod',
    updateFailed: 'Could not update mod',
    reorderFailed: 'Could not save load order',
  },
  metrics: {
    title: 'Server metrics',
    subtitle: 'Live CPU, memory and player counts for your servers.',
    refresh: 'Refresh now',
    ...
    noServers: 'No servers yet.',
    partialPlayerCount: 'Some servers did not report a player count.',
    cpu: 'CPU',
    memory: 'Memory',
    players: 'Players',
    unknown: 'Unknown',
    notRunning: 'Not running',
    acrossCores: 'across {count} cores',
    severity: { good: 'Normal', warning: 'High', critical: 'Critical' },
    status: { running: 'Running', stopped: 'Stopped' },
    errors: {
      'docker unavailable': 'Docker is unavailable.',
      'container not found': 'Container not found.',
      'stats unavailable': 'Resource stats unavailable.',
    },
  },
  auditLogs: {
    title: 'Audit Logs',
